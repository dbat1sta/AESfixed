...
if __name__ == "__main__":
    ...
    # TEST VECTOR C.2
    plaintext = bytearray.fromhex('00112233445566778899aabbccddeeff')
    expected_ciphertext_2 = bytearray.fromhex('dda97ca4864cdfe06eaf70a0ec0d7191')
    key_2 = bytearray.fromhex('000102030405060708090a0b0c0d0e0f1011121314151617')
    ciphertext_2 = aes_encryption(plaintext, key_2)

    assert (ciphertext_2 == expected_ciphertext_2)

    # TEST VECTOR C.3
    plaintext = bytearray.fromhex('00112233445566778899aabbccddeeff')
    expected_ciphertext_3 = bytearray.fromhex('8ea2b7ca516745bfeafc49904b496089')
    key_3 = bytearray.fromhex('000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f')
    ciphertext_3 = aes_encryption(plaintext, key_3)
    ...
    print()
    print("Plaintext:", plaintext)
    print("Ciphertext:", expected_ciphertext_2)
    print("Decrypted:", plaintext_decrypted_2)
    print()
    print("Plaintext:", plaintext)
    print("Ciphertext:", expected_ciphertext_3)
    print("Decrypted:", plaintext_decrypted_3)
